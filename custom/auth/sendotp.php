...
if (($_ENV['MAILPACE_SERVER_TOKEN'] ?? false) && ($_POST['otp'] ?? false)) {
  ...
  try {
      ...
      //Recipients
      $mail->setFrom('no-reply@tribe-framework.org', 'Tribe');
      $mail->addAddress($_POST['email']);     //Add a recipient

      //Content
      $mail->isHTML(true);                                  //Set email format to HTML
      $mail->Subject = 'Your OTP is '.$_POST['otp'];
      $mail->Body    = '<h1 align="center">'.$_POST['otp'].' is your OTP</h1><div align="center"><img src="https://tribe-framework.org/favicon.png" width="200" /></div>';
